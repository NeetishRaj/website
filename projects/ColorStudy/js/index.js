...
window.onload = function() {
    ...
    btn.onclick = function() {
        if (ipr.value > 255 || ipr.value < 0) {
            ...
            setTimeout(function() {
                post.style.animation = "posts 3s 2 alternate forwards";
            }, 300);
    ...
    sch.onclick = function() {
        if (sch.value == "HSL mode") {
            ...
            alert("In RGB mode the 3 parameters are\n1.Red (0-255) in decimal\n2.Green (0-255) in decimal\n3.Blue (0-255) in decimal\n\nNote that in Hexadecimal representation of rgb color we convert 0-255 value in decimal to 00-ff hexadecimal for each color");
            sch.value = "HSL mode";
            ip1.textContent = "RED";
